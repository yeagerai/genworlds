...
from yeager_core.interactions.base_interactions import (
...
LLM = ChatOpenAI(
    max_tokens=5000, openai_api_key=openai_api_key
)  # Can be any LLM you want.

ytools = GenerativeAgent(
    name="yTools",
    description="25",
    ...
    llm=LLM,
    daily_summaries=["He is looking actively to build tools that work seamlessly."],
