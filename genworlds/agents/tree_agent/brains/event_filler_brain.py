...
class EventFillerBrain:
    ...
    def __init__(
        ...
        self.eval_prompt = ExecutionGeneratorPrompt(
            ...
            ai_role="You are {ai_name}. You need to evaluate the provided set of JSON parameters based on their correctness, with respect to all of the following information:".format(ai_name=ai_name),
