...
class PodcastBrain:
    ...
    def __init__(
        self, openai_api_key, ai_name: str, model_name="gpt-3.5-turbo", search_algorithm="BFS"
    ):
        ...
        self.gen_prompt = ExecutionGeneratorPrompt(
            ...
            ai_role="You are {ai_name}, an expert podcaster. You have to generate a podcast response based on:".format(ai_name=ai_name),
        ...
        self.eval_prompt = ExecutionGeneratorPrompt(
            ...
            ai_role="You are {ai_name}, an expert in evaluating the quality and the depth of a podcast response based on:".format(ai_name=ai_name),
