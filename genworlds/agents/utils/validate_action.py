...
def validate_action(agent_id: str, action_schema: str, pre_filled_event: dict, all_action_schemas: dict):
    ...
    try:
        ...
        summary = one_line_summarizer.summarize(
        ...
        return f"Validation Error in args: {str(e)}, pre_filled_event: {pre_filled_event}"
    except Exception as e:
        return f"Error: {str(e)}, {type(e).__name__}, pre_filled_event: {pre_filled_event}"