...
class WebsocketEventHandler:
    ...
    def register_event_listener(self, event_class: type[Event], event_listener: Callable):
    ...
    def unregister_event_listener(self, event_class: type[Event], event_listener: Callable):
    ...
    def process_event(self, event):
        if (
            event["event_type"] in self.listeners and
