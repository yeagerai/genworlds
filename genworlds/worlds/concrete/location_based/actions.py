...
from genworlds.worlds.concrete.base.actions import AgentGetsAvailableEntitiesEvent, WorldSendsAvailableEntitiesEvent, WorldSendsAvailableActionSchemasEvent
...
class WorldSetsAgentLocation(AbstractAction):
    ...
    def __call__(self, event: AgentMovesToNewLocation):
        ...
        self.host_object.get_entity_by_id(event.sender_id).location = event.destination_location
