...
podcast_host = TreeAgent(
    ...
    navigation_brain=NavigationBrain(
        ...
        generator_results_prompt="""# Response type
                ...
                - {{ "steps_completed": "Here are the steps of the previous plan I have completed with my recent actions.", "plan": "A numbered list of the updated plan", "goal": "Here is what I want to achieve in my next step using the next_action I select",  "next_action": "EntityClass:event_type_1", "is_action_valid": "Assess whether the action is valid based on the current state of the world."}}
                - {{ "steps_completed": "Here are the steps of the previous plan I have completed with my recent actions.", "plan": "A numbered list of an alternative updated plan", "goal": "Here is what I want to achieve in my next step using the next_action I select", "next_action": "EntityClass:event_type_1", "is_action_valid": "Assess whether the action is valid based on the current state of the world."}}
                - {{ "steps_completed": "Here are the steps of the previous plan I have completed with my recent actions.", "plan": "A numbered list of a third updated plan", , "goal": "Here is what I want to achieve in my next step using the next_action I select", "next_action": "EntityClass:event_type_2", "is_action_valid": "Assess whether the action is valid based on the current state of the world."}}
                """,
        evaluator_role_prompt="You are Maria Podcastonova, an expert in evaluating which events get you closer to achieving your goals based on:",
        evaluator_results_prompt="""## Action to evaluate
                ...
                Check that the proposed action is correct, and that you meet all the preconditions for the action, like having the correct items in your inventory.
    ...
    execution_brains={
        ...
        "event_filler_brain": EventFillerBrain(
            openai_api_key,
            n_of_thoughts=1,
            generator_role_prompt="""You are Maria Podcastonova, an expert podcaster and the host of the Rountable podcast. In previous steps, you have selected an action to execute, and possibly generated some of the response parameters in a previous step - make sure to include those exactly. 
...
podcast_guest = TreeAgent(
    ...
    navigation_brain=NavigationBrain(
        ...
        generator_results_prompt="""# Response type
                Look at your previous plan, your memories about what you have done recently and your goals, and propose a new plan that advances your goals.
                Check if you have already completed a step in your plan, and if so, propose the next step as the first one.
                Output a bullet list containing {num_thoughts} of possible plans and next events that help you achieve your large scale goals. You can propose the same event multiple times with different goals in mind. 
                If none of the actions make sense, you can also use the action "Self:wait". 
                Use the following format:
                - {{ "steps_completed": "Here are the steps of the previous plan I have completed with my recent actions.", "plan": "A numbered list of the updated plan", "goal": "Here is what I want to achieve in my next step using the next_action I select",  "next_action": "EntityClass:event_type_1", "is_action_valid": "Assess whether the action is valid based on the current state of the world."}}
                - {{ "steps_completed": "Here are the steps of the previous plan I have completed with my recent actions.", "plan": "A numbered list of an alternative updated plan", "goal": "Here is what I want to achieve in my next step using the next_action I select", "next_action": "EntityClass:event_type_1", "is_action_valid": "Assess whether the action is valid based on the current state of the world."}}
                - {{ "steps_completed": "Here are the steps of the previous plan I have completed with my recent actions.", "plan": "A numbered list of a third updated plan", , "goal": "Here is what I want to achieve in my next step using the next_action I select", "next_action": "EntityClass:event_type_2", "is_action_valid": "Assess whether the action is valid based on the current state of the world."}}
    ...
    execution_brains={
        ...
        "event_filler_brain": EventFillerBrain(
            openai_api_key,
            n_of_thoughts=1,
            generator_role_prompt="""You are Jimmy Artificles, a world-renowned AI researcher and a guest of the Rountable podcast. In previous steps, you have selected an action to execute, and possibly generated some of the response parameters in a previous step - make sure to include those exactly. 
                You now need to generate a valid set of JSON parameters for the command to execute, based on the following information:
            """,
            generator_results_prompt="""# Response type
                {num_thoughts} lines of json containing possible options for completing the arguments of the command to execute, each one with the following format AND NOTHING ELSE:
